...
public class DataRedacteur extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DataRedacteur frame = new DataRedacteur();
	...
	public DataRedacteur() {
		...
		btnAjouter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try
				{
					ps=con.prepareStatement("INSERT INTO `data_storage`(`image`, `text`) VALUES (?,?)");
